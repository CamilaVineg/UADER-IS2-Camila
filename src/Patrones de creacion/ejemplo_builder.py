...
class BuilderPCBarata(BuilderComputadora):
    """Builder concreto para una PC Gamer."""

    def construir_cpu(self) -> None:
        self._producto.agregar("CPU Barata")

    def construir_memoria(self) -> None:
        self._producto.agregar("8GB RAM")

    def construir_almacenamiento(self) -> None:
        self._producto.agregar("Disco duro viejo")
...
class Director:
    ...
    def construir_computadora_bARATA(self) -> None:
        self._builder.construir_cpu()
        self._builder.construir_memoria()
...
def main() -> None:
    ...
    builder_pcbarata = BuilderPCBarata()
    director = Director(builder_pcbarata)
    pc_barata = builder_pcbarata.obtener_resultado()
    print("PC Barata:")
    print(pc_barata.mostrar()) #aca no anda, hay que revisar.
